...
@section('title', 'Stok Penggilingan')
@section('content')
<div class="acc-header col-xl-3 col-md-6 py-2 mt-4 rounded-3 d-flex justify-content-center">Stok Penggilingan</div>
<div class="row">
  <div class="add-admin col-xl-4 col-md-6">
    @can('create', \App\Models\StokGudang::class)
      <a href="/stock/penggilingan/create">
        <button type="button" class="btn btn-primary my-4" id="tambah-pengeringan">
          <i class="fa-solid fa-pencil"></i>
          <span class="ps-2 fw-bolder"> Tambah Stok Penggilingan</span>
        </button>
      </a>
    @endcan
  </div>
...
<div class="row">
  <div class="tabel-adm col-xl-3 col-md-6 mx-auto">
    <h4 class="pt-4 pb-3">Daftar Stok Penggilingan</h4>
    @if (session('success'))
      ...
      <table class="table table-bordered">
        ...
        <tbody class="align-middle">
          ...
          <tr>
            ...
            @can('update', $row)
              <td>
                <a href="/stock/penggilingan/{{ $row->id }}/edit"><button type="button" class="edit-btn rounded-3 ms-2 my-1"><i class="fa-solid fa-pen-to-square"></i></button></a>
...
<script>
   $(document).ready(function(){
    ...
    $('.delete-btn').click(function () {
      var penggilingan_id = $(this).attr('data-id')
      swal({
            // title: "Are you sure?",
      ...
      .then((willDelete) => {
        if (willDelete) {
          window.location = "/stock/penggilingan/"+penggilingan_id+"/delete"
