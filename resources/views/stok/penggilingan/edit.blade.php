...
@section('title', 'Edit Stok Penggilingan')
@section('content')
...
<div class="row mt-4 mx-3 d-flex justify-content-center">
    <div class="add-admin col-12 bg-white">
        <form id="save-penggilingan-form" action="/stock/penggilingan/{{ $data->id }}/editData" class="pt-5 px-md-3" method="post" enctype="multipart/form-data">
            @csrf
