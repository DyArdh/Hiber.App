...
@section('title', 'Edit Stok Penyortiran 2')
@section('content')
...
<div class="row mt-4 mx-3 d-flex justify-content-center">
    <div class="add-admin col-12 bg-white">
        <form id="save-penyortiran-form" action="{{ route('penyortiran2.update', $data->id) }}" class="pt-5 px-md-3" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
