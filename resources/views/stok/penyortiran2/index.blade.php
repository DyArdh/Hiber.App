...
@section('title', 'Stok Penyortiran 2')
@section('content')
 
<div class="acc-header col-xl-3 col-md-6 py-2 mt-4 rounded-3 d-flex justify-content-center">Penyortiran 2</div>
    <div class="row">
      @can('create', \App\Models\StokGudang::class)
        <a href="{{ route('penyortiran2.create') }}">
          ...
          <table class="table table-bordered" id="tableAdmin">
            ...
            <tbody class="align-middle">
              ...
              <tr>
                  ...
                  @can('update', \App\Models\StokGudang::class)
                    <td class="d-flex">
                      <a href="{{ route('penyortiran2.edit', $row->id) }}">
                        <button type="button" class="edit-btn rounded-3 ms-2 my-1"><i class="fa-solid fa-pen-to-square"></i></button>
                      </a>
                      <form id="delete-penyortiran2-form" action="{{ route('penyortiran2.destroy', $row->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
