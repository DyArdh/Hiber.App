...
@section('title', 'Tambah Stok Penyortiran 1')
@section('content')
...
<div class="row mt-4 mx-3 d-flex justify-content-center">
    <div class="add-admin col-12 bg-white">
        <form id="save-penyortiran-form" action="{{ route('penyortiran.store') }}" class="pt-5 px-md-3" method="post" enctype="multipart/form-data">
            @csrf
